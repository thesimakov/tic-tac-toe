...
(function (G) {
  ...
  G.texts = {
    ru: {
      ...
      score: "Очки",
      vkAdsTitle: "Реклама",
      vkAdsHint: "В клиенте ВК баннер может появиться у правого края экрана.",
      vkAdsSlotAria: "Реклама ВКонтакте",
    ...
    en: {
      ...
      score: "Score",
      vkAdsTitle: "Ads",
      vkAdsHint: "In the VK app, a banner may appear along the right edge.",
      vkAdsSlotAria: "VK ads",
      adNoticeTitle: "Ad",
